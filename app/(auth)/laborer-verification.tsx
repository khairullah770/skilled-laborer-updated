...
export default function LaborerVerificationScreen() {
    ...
    const handleVerify = () => {
        // Verify logic
        router.replace('/(laborer)/(tabs)/jobs');
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.title}>Laborer Verification</Text>
...
const styles = StyleSheet.create({
    ...
    title: {
        fontSize: 24,
        fontWeight: 'bold',
        color: '#1F41BB', // Updated to match laborer theme
        marginBottom: 20,
    },
    subtitle: {
        fontSize: 14,
